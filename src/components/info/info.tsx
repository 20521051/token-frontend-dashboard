...
function Info({ ...props }: InfoProps) {
  ...
  return (
    <div className='bg-[#141828] p-2 text-white flex w-[920px] border-[2px] border-black border-solid'>
      <div className='flex items-center w-[110px] border-r-[2px] border-white border-solid'>
        <img
      ...
      <div className='w-full pl-[30px] pr-[250px] text-[14px] font-thin'>
